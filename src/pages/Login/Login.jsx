...
export default function Login() {
  ...
  async function handleSubmit(e) {
    ...
    setSubmitting(true);
    try {
      const res = await loginAdmin({ mobile, otp }); // backend verifies OTP directly
      ...
      <div className="an-login-wrapper">
        ...
        <div className="an-login-card">
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            <button type="button" className="an-submit" onClick={handleSendOtp}>
              Send OTP
            </button>
          </form>
        </div>
        ...
        <div className="otp-modal-overlay">
          <div className="otp-modal">
            ...
            <div className="otp-modal-buttons">
              ...
              <button onClick={() => setShowOtpModal(false)} className="otp-cancel">
                Cancel
              </button>
            </div>
          </div>
